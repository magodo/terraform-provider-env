...
**NOTE**: Accessing environment variables in a Terraform module is a violation of *Terraform's language design* where it *tries to avoid situations where a module's definition depends on anything other than its own source code and its input variables*.  See [this](https://github.com/hashicorp/terraform/issues/26477#issuecomment-703845535) for details.
